...
>| Files.Read | Delegated | Read all files |  |
>| Files.Read.All | Delegated | Read all files that user can access |  |
>| Files.Read.Selected | Delegated | Read files that the user selects |  |
>| Tasks.Read | Delegated | Read user tasks |  |
>| Tasks.ReadWrite | Delegated | Create, read, update and delete user tasks and projects |  |

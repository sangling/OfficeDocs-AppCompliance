...
Information provided by Adobe Systems Inc. on how this app collects and stores organizational data, and what control an organization has over this data.
...
>|:----------------|:--------------------------|:--------------------------|:---------------------------------------------------|
>| Mail.ReadWrite | Application | To identify the Microsoft user so that we can refer to their data related to Adobe Sign in our service. | Email id is stored in our database. |
>| People.Read | Application | To identify the Microsoft user so that we can refer to their data related to Adobe Sign in our service. |  |
>| offline_access | Application | To identify the Microsoft user so that we can refer to their data related to Adobe Sign in our service. |  |
>| openid | Application | To identify the Microsoft user so that we can refer to their data related to Adobe Sign in our service. |  |
>| User.Read | Application | To identify the Microsoft user so that we can refer to their data related to Adobe Sign in our service. |  |
...
<iframe height='1020' title='Microsoft Cloud App Security Information' src='https://3ca685143b5b46b4b0e5266dadf2e97c.codepen.website/#/dashboard/27582' frameborder='no'  style='width: 100%;'></iframe>
